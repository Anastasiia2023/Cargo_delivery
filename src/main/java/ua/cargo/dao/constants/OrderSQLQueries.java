...
public final class OrderSQLQueries {
    ...
    public static final String GET_ORDERS_BY_USER_PAGINATED_ORDERED = "SELECT * FROM orders WHERE user_id=? %s ORDER BY ? ? LIMIT ? OFFSET ?";
    ...
    public static final String GET_ORDERS_PAGINATED_ORDERED = "SELECT * FROM orders %s ORDER BY ? ? LIMIT ? OFFSET ?";
