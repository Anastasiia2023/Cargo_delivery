...
public final class UserSQLQueries {
    public static final String ADD_USER = "INSERT INTO user (email, password, name, surname, phone, role) VALUES (?,?,?,?,?,?)";
    ...
    public static final String UPDATE_USER = "UPDATE user SET email=?, name=?, surname=?, phone=? WHERE id=?";
