...
public final class RouteSQLQueries {
    ...
    public static final String GET_ROUTES_PAGINATED_ORDERED = "SELECT * FROM route ORDER BY ? ? LIMIT ? OFFSET ?";
    ...
    public static final String GET_ROUTE_BY_CITIES_PAGINATED_ORDERED = "SELECT * FROM route WHERE city_from_id=? AND city_to_id=? ORDER BY ? ? LIMIT ? OFFSET ?";
    ...
    public static final String GET_ROUTES_BY_CITY_FROM_PAGINATED_ORDERED = "SELECT * FROM route WHERE city_from_id=? ORDER BY ? ? LIMIT ? OFFSET ?";
    ...
    public static final String GET_ROUTES_BY_CITY_TO_PAGINATED_ORDERED = "SELECT * FROM route WHERE city_to_id=? ORDER BY ? ? LIMIT ? OFFSET ?";
