...
public final class Parameters {
    ...
    public static final String CITY_FROM_ID = "city-from-id";
    public static final String CITY_TO_ID = "city-to-id";
    ...
    public static final String ORDER_STATUS_ATTRIBUTE = "orderStatus";
    public static final String LIST_ORDERS_STATUS = "orderStatuses";
    ...
    public static final String COST = "user-cost";
